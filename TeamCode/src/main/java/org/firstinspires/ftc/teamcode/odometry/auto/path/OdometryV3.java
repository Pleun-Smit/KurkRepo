...
public class OdometryV3 {
     ...
     */
    public OdometryV3(HardwareMap hardwareMap) {
    ...
    public void updatePose() {
        ...
        double currentHeading = imu.getPosition().y; //als alles kurk is Z veranderen naar Y of andersom
